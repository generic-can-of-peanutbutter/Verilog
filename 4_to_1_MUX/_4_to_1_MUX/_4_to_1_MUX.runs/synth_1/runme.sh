...
HD_PWD='D:/VIVADO circuits/_4_to_1_MUX/_4_to_1_MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _4to1MUX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _4to1MUX.tcl

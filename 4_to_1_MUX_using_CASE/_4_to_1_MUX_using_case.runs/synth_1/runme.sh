...
HD_PWD='D:/VIVADO circuits/_4_to_1_MUX_using_case/_4_to_1_MUX_using_case.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _4_to_1_MUX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _4_to_1_MUX.tcl

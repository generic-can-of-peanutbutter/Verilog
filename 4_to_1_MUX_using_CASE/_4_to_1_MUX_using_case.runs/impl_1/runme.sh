...
HD_PWD='D:/VIVADO circuits/_4_to_1_MUX_using_case/_4_to_1_MUX_using_case.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _4_to_1_MUX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _4_to_1_MUX.tcl -notrace

...
HD_PWD='D:/VIVADO circuits/oscillate_always/oscillate_always.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oscillate.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oscillate.tcl -notrace

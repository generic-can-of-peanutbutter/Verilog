...
HD_PWD='D:/VIVADO circuits/oscillate_always/oscillate_always.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oscillate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oscillate.tcl
